...
if (video_file):
    ...
    cut_start_time = cuts_form.text_input("Início do corte", placeholder="00:00:00", max_chars=8)
    ...
    # list cuts
    st.sidebar.header("Cortes")
    left_column, right_column = st.sidebar.columns(2)
    if (len(st.session_state.cuts)):
        left_column.write("Início do corte")
        right_column.write("Fim do corte")
